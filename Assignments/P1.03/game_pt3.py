...
class PacmanSprite(pygame.sprite.Sprite):
    ...
    def Move(self,events):
        ...
        if not dead and not dead2:
            ...
            #self.screen.blit(self.image, (self.x-mid, self.y-mid),(960,self.tilesize,self.tilesize,self.tilesize))
            #frame = 1200 is death4
            #frame = 1130 is death3
            #frame = 1050 is death2
            #frame = 960 is death1
        elif dead and not dead2:
            self.frame_nums2 = [0,1,2]
            self.callCounter += 1
            # increment frame counter based on the delay we set
            if self.callCounter % self.delay == 0:
                self.frameCounter+= 1
            ...
            # xoffset picks the color of the ghost
            xoffset = self.color_offset
            frame = xoffset + self.frame_nums2[self.frameCounter%len(self.frame_nums2)]*self.tilesize + 160
            self.screen.blit(self.image, (self.x-mid, self.y-mid),(frame,self.tilesize,self.tilesize,self.tilesize))
            if frame == 1040:
                #dead2 = True
                frame = 970
        if dead2:
            self.frame_nums2 = [0,1]
            self.callCounter += 1
            # increment frame counter based on the delay we set
            if self.callCounter % self.delay == 0:
                self.frameCounter+= 1
            ...
            # xoffset picks the color of the ghost
            xoffset = self.color_offset
            frame = xoffset + self.frame_nums2[self.frameCounter%len(self.frame_nums2)]*self.tilesize + 410
            self.screen.blit(self.image, (self.x-mid, self.y-mid),(frame,self.tilesize,self.tilesize,self.tilesize))
            dead = False
            ...
            if 'N' in self.cardinal_direction :
                if self.cy >= self.target_location[1]:
                    if self.cy + -self.step >= -self.boundy:
                        ...
                        pygame.draw.rect(self.screen,pygame.Color("red"),[0, 200, self.gh, 10])
            ...
            if 'S' in self.cardinal_direction :
                if self.cy <= self.target_location[1]:
                    if self.cy + self.step <= self.boundy:
                        ...
                        pygame.draw.rect(self.screen,pygame.Color("red"),[0, 300, self.gh, 10])
                        if self.showmessage == True:
                            self.showmessage = False
                            Tk().wm_withdraw() #to hide the main window
            ...
            if 'E' in self.cardinal_direction :
                if self.cx <= self.target_location[0]:
                    if self.cx + self.step <= self.boundx:
                        ...
                        pygame.draw.rect(self.screen,pygame.Color("red"),[300, 0, 10, self.gw])
                        if self.showmessage == True:
                            self.showmessage = False
                            Tk().wm_withdraw() #to hide the main window
            ...
            if 'W' in self.cardinal_direction :
                if self.cx >= self.target_location[0]:
                    if self.cx + -self.step >= -self.boundx:
                        ...
                        pygame.draw.rect(self.screen,pygame.Color("red"),[200, 0, 10, self.gw])
                        if self.showmessage == True:
                            self.showmessage = False
                            Tk().wm_withdraw() #to hide the main window
